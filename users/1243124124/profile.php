...
<?php endif; ?>
	...
	<script type="text/javascript" onerror="Roblox.BundleDetector && Roblox.BundleDetector.reportBundleError(this)" data-monitor="true" data-bundlename="ProfileStatistics" id="ProfileStatistics" userid="<?=$uid?>" data-bundle-source="Main" src="/privateJs/ProfileStatistics.js"></script>
